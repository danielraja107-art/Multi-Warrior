...
const DEMO_PLAYERS: HUDPlayer[] = [
  { id: '1', name: 'You', color: PlayerColor.RED, health: 85, maxHealth: 100, weapon: WeaponType.AXE, isAlive: true, isLocal: true, isDead: false },
  { id: '2', name: 'Ally', color: PlayerColor.BLUE, health: 62, maxHealth: 100, weapon: WeaponType.BASEBALL_BAT, isAlive: true, isLocal: false, isDead: false },
  { id: '3', name: 'Sniper', color: PlayerColor.GREEN, health: 100, maxHealth: 100, weapon: WeaponType.ROCK, isAlive: true, isLocal: false, isDead: false },
                ...
                {player.id ? (
                  <>
                    ...
                    <div className="flex items-center justify-between mt-1">
                      ...
                      <span className="text-xs">{weaponEmoji[player.weapon]}</span>
                    </div>
                  </>
                ) : (
