...
async function main() {
    ...
    if (dbBoot.ok) {
        try {
            ...
            logger_1.logger.warn('startup', 'Failed to ensure achievement definitions', { message: String(err) });
        }
    }
    else {
        logger_1.logger.warn('startup', 'Database offline; achievement initialization deferred.');
    }
