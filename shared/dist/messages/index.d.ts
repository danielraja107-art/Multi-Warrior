...
export declare const MESSAGE_CLIENT: {
    readonly PLAYER_MOVE: "PLAYER_MOVE";
    readonly PLAYER_ATTACK: "PLAYER_ATTACK";
    readonly PLAYER_DODGE: "PLAYER_DODGE";
    readonly PLAYER_BLOCK: "PLAYER_BLOCK";
    readonly PLAYER_PICKUP: "PLAYER_PICKUP";
    readonly PLAYER_THROW: "PLAYER_THROW";
    readonly HOST_START: "HOST_START";
    readonly HOST_CHANGE_DIFFICULTY: "HOST_CHANGE_DIFFICULTY";
};
export declare const MESSAGE_SERVER: {
